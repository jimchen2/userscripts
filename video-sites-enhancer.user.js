...
(function () {
  ...
  async function extractSubtitleUrl() {
    ...
    if (hasForeignTrack) {
      const autoGeneratedTrack = playerData.find((track) => ["a.ru", "a.de", "a.es"].includes(track.vssId));
      const manualTrack = playerData.find((track) => ["ru", "de", "es"].some((code) => track.vssId.includes(code)));
