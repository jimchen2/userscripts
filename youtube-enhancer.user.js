...
(function () {
  ...
  async function extractSubtitleUrl() {
    ...
    if (hasForeignTrack) {
      const autoGeneratedTrack = playerData.find((track) => ["a.ru", "a.de"].includes(track.vssId));
      const manualTrack = playerData.find((track) => ["ru", "de"].some((code) => track.vssId.includes(code)));
